...
function demoDoctorSeedAvatar(gender: 'male' | 'female'): string {
  return gender === 'female'
    ...
    : 'flutter-asset:assets/images/avatars/doctor_male.png';
}
...
type DoctorSeed = {
  ...
  /** Demo avatar gender maps to flat illustrations under `assets/images/avatars/`. */
  gender: 'male' | 'female';
};
...
const DOCTOR_SEEDS: DoctorSeed[] = [
  ...
  {
    email: 'doctor.erdenebold@clinova.local',
    firstName: 'Эрдэнэболд',
    lastName: 'Энхбат',
    phone: '99112234',
    branchCode: 'CLIN_TUV',
    departmentName: 'Дотор',
    primaryServiceName: 'Ерөнхий үзлэг',
    bio: 'Дотрын эмч — дотоодын эрхтний ерөнхий үзлэг, даралт, чихэрийн зөвлөгөө.',
    experienceYears: 9,
    consultationFee: 30_000,
    gender: 'male',
  },
  {
    email: 'doctor.bolormaa@clinova.local',
    firstName: 'Болормаа',
    lastName: 'Сүхбаатар',
    phone: '99112235',
    branchCode: 'CLIN_TUV',
    departmentName: 'Дотор',
    primaryServiceName: 'Ерөнхий үзлэг',
    bio: 'Дотрын эмч — уламжлалт ба эрүүл ахуйн зөвлөгөө, урьдчилан сэргийлэлт.',
    experienceYears: 7,
    consultationFee: 30_000,
    gender: 'female',
  },
  ...
  {
    email: 'doctor.ganbold@clinova.local',
    firstName: 'Ганболд',
    lastName: 'Энхбаяр',
    phone: '88071575',
    branchCode: 'CLIN_HUHD',
    departmentName: 'Хүүхэд',
    primaryServiceName: 'Хүүхдийн үзлэг',
    bio: 'Хүүхдийн эмч — халуурах, дэвсэг, хоол тэжээлийн зөвлөгөө.',
    experienceYears: 6,
    consultationFee: 35_000,
    gender: 'male',
  },
  ...
  {
    email: 'doctor.undrakh@clinova.local',
    firstName: 'Өндөрхүү',
    lastName: 'Батбаяр',
    phone: '88112234',
    branchCode: 'CLIN_GEM',
    departmentName: 'Гэмтэл согог',
    primaryServiceName: 'Гэмтлийн зөвлөгөө',
    bio: 'Гэмтэл, согог — спортын гэмтэл, сэргээн заслын төлөвлөгөө.',
    experienceYears: 11,
    consultationFee: 40_000,
    gender: 'male',
  },
  ...
  {
    email: 'doctor.altangerel@clinova.local',
    ...
    departmentName: 'Арьс харшил',
    primaryServiceName: 'Арьс харшлын үзлэг',
    bio: 'Арьс харшил — тууралт, харшлын шалтгаан, арьсны төлөвлөгөөтой үзлэг.',
    experienceYears: 8,
    consultationFee: 35_000,
    gender: 'male',
  },
  ...
  for (const doc of DOCTOR_SEEDS) {
    ...
    const user = await prisma.user.upsert({
      ...
      create: {
        ...
        phoneNumber,
        branchId: branch.id,
        avatarUrl: demoDoctorSeedAvatar(doc.gender),
      },
      update: {
        firstName: doc.firstName,
        lastName: doc.lastName,
