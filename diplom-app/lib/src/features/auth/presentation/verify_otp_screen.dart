    ...
    return AuthScaffold(
      leading: Tooltip(
        ...
        child: IconButton.filledTonal(
          onPressed: () => _goBackToCredentialStep(context, authState),
          icon: const Icon(Icons.arrow_back_rounded),
        ),
      ),
      sidePanel: const AuthMarketingSide(variant: AuthMarketingVariant.verify),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: theme.textTheme.titleSmall?.copyWith(color: _muted),
                  ),
                  const SizedBox(height: 16),
                  Row(
