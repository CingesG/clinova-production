...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen<AuthState>(authControllerProvider, (prev, next) {
      ...
      final pending = (next.pendingEmail ?? emailController.text)
          .trim()
          .toLowerCase();
      if (pending.endsWith('@clinova.local')) return;
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text(l10n.authRegisterCheckEmailSnack)));
    ...
    return AuthScaffold(
      ...
      sidePanel: const AuthMarketingSide(
        variant: AuthMarketingVariant.register,
      ),
